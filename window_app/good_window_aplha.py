...
class Ui_main_window(QMainWindow):
    ...
    def refresh_camera_list(self):
        ...
        if temp >= 0:
            self.camera_combo_box.setCurrentText(str(temp))
    def set_camera(self):
        temp=self.cont.get_camera_controller().set_used_camera_number(int(self.camera_combo_box.currentText()))
        if temp >= 0:
            self.camera_combo_box.setCurrentText(str(temp))
    ...
    def get_config(self):
            ...
            self.druming_fingers_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(1)))
            self.rolling_hand_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(2)))
            self.rolling_hand_forward_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(3)))
            self.stop_sign_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(4)))
            self.swiping_down_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(5)))
            self.swiping_left_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(6)))
            self.swiping_right_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(7)))
            self.swiping_up_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(8)))
            self.thumb_down_combo_box_2.setCurrentText(self.nm.get_user_friendly_action_name(config.get(9)))
            self.thumb_down_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(10)))
            self.turrning_hand_clock_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(11)))
            self.turning_hand_counter_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(12)))
            self.pulling_hand_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(13)))
            self.pushing_hand_away_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(14)))
            self.pulling_two_fingers_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(15)))
            self.pushing_two_fingers_away_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(16)))
            self.sliding_two_fingers_left_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(17)))
            self.sliding_two_fingers_right_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(18)))
            self.sliding_two_fingers_down_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(19)))
            self.sliding_two_fingers_up_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(20)))
            self.zooming_in_with_full_hand_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(21)))
            self.zooming_out_with_fiull_hand_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(22)))
            self.zooming_in_with_two_fing_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(23)))
            self.zooming_out_with_two_fing_combo_box.setCurrentText(self.nm.get_user_friendly_action_name(config.get(24)))
    ...
    def set_config(self):
        dict={}
        dict[1] = self.nm.get_normal_action_name(self.self.druming_fingers_combo_box.currentText())
        dict[2] = self.nm.get_normal_action_name(self.rolling_hand_combo_box.currentText())
        dict[3] = self.nm.get_normal_action_name(self.rolling_hand_forward_combo_box.currentText())
        dict[4] = self.nm.get_normal_action_name(self.stop_sign_combo_box.currentText())
        dict[5] = self.nm.get_normal_action_name(self.swiping_down_combo_box.currentText())
        dict[6] = self.nm.get_normal_action_name(self.swiping_left_combo_box.currentText())
        dict[7] = self.nm.get_normal_action_name(self.swiping_right_combo_box.currentText())
        dict[8] = self.nm.get_normal_action_name(self.swiping_up_combo_box.currentText())
        dict[9] = self.nm.get_normal_action_name(self.thumb_down_combo_box_2.currentText())
        dict[10] = self.nm.get_normal_action_name(self.thumb_down_combo_box.currentText())
        dict[11] = self.nm.get_normal_action_name(self.turrning_hand_clock_combo_box.currentText())
        dict[12] = self.nm.get_normal_action_name(self.turning_hand_counter_combo_box.currentText())
        dict[13] = self.nm.get_normal_action_name(self.pulling_hand_combo_box.currentText())
        dict[14] = self.nm.get_normal_action_name(self.pushing_hand_away_combo_box.currentText())
        dict[15] = self.nm.get_normal_action_name(self.pulling_two_fingers_combo_box.currentText())
        dict[16] = self.nm.get_normal_action_name(self.pushing_two_fingers_away_combo_box.currentText())
        dict[17] = self.nm.get_normal_action_name(self.sliding_two_fingers_left_combo_box.currentText())
        dict[18] = self.nm.get_normal_action_name(self.sliding_two_fingers_right_combo_box.currentText())
        dict[19] = self.nm.get_normal_action_name(self.sliding_two_fingers_down_combo_box.currentText())
        dict[20] = self.nm.get_normal_action_name(self.sliding_two_fingers_up_combo_box.currentText())
        dict[21] = self.nm.get_normal_action_name(self.zooming_in_with_full_hand_combo_box.currentText())
        dict[22] = self.nm.get_normal_action_name(self.zooming_out_with_fiull_hand_combo_box.currentText())
        dict[23] = self.nm.get_normal_action_name(self.zooming_in_with_two_fing_combo_box.currentText())
        dict[24] = self.nm.get_normal_action_name(self.zooming_out_with_two_fing_combo_box.currentText())
    ...
    def set_cameras_combo_box(self, lst):
            ...
            for a in lst:
                    self.setCamera_combobox.addItem("Camera "+str(a))
    ...
    def setupUi(self, main_window):
        ...
        self.to_bedzie_camera_label.setStyleSheet("")
        self.to_bedzie_camera_label.setText("")
        #self.to_bedzie_camera_label.setPixmap(QtGui.QPixmap(":/nowyPrzedrostek/PROJEKTY/proj_zespolowy/Sterowanie-interfejsem-system-w-operacyjnym-przy-pomocy-gestow/gesture_images/mouse_stering_gestures/stop_mouse_mode.png"))
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -1190, 865, 1938))
...
"")
        ...
        for i in action_names:
                self.druming_fingers_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.rolling_hand_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.rolling_hand_forward_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.stop_sign_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.swiping_down_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.swiping_left_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.swiping_right_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.swiping_up_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.thumb_down_combo_box_2.addItem(self.nm.get_user_friendly_action_name(i))
                self.thumb_down_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.turrning_hand_clock_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.turning_hand_counter_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.pulling_hand_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.pushing_hand_away_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.pulling_two_fingers_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.pushing_two_fingers_away_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.sliding_two_fingers_left_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.sliding_two_fingers_right_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.sliding_two_fingers_down_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.sliding_two_fingers_up_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.zooming_in_with_full_hand_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.zooming_out_with_fiull_hand_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.zooming_in_with_two_fing_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
                self.zooming_out_with_two_fing_combo_box.addItem(self.nm.get_user_friendly_action_name(i))
        self.get_config()
        arr = self.cont.get_camera_controller().get_all_cameras()
        for i in arr:
                self.camera_combo_box.addItem(str(i))
        #self.refreshCameras_Button.clicked.connect(lambda: self.refresh_camera_list()) nie ma
        self.authors_button.clicked.connect(lambda: print("authors"))
        self.help_button.clicked.connect(lambda: print("dokumentacja"))
        self.camera_combo_box.activated.connect(lambda: self.set_camera())
        self.start_button.clicked.connect(lambda: self.cont.start_gesture_recognition())        #tu zmiana wlasciwosci na stop button bedzie jeszcze
