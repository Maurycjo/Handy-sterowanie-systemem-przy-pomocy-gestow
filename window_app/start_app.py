...
class StartApp(QWidget):
    ...
    def initUI(self):
            ...
            self.setStyleSheet("background-color: #D7D7D7;border: 1px solid #c4c4c4;")
            ...
            self.button.setStyleSheet("background-color: #DFE6F8; text-align: center;border:none;")
            self.button.setFixedSize(200,30)            
            self.layout.addWidget(self.button, alignment=Qt.AlignCenter | Qt.AlignBottom)
